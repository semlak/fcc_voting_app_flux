...
export default React.createClass({
  ...
  getInitialState: function() {
  	...
  	return {
  		...
  		answer_options: this.props.poll_answer_options,
  		votes: this.props.poll_votes
  	};
  },
	componentWillReceiveProps: function(nextProps) {
		...
		// }
		if (nextProps.poll_answer_options) {
			if (nextProps.poll_answer_options > this.state.answer_options) {
				this.setState({answer_options: nextProps.poll_answer_options});
			}
			if (nextProps.poll_votes > this.state.votes) {
				this.setState({votes: nextProps.poll_votes});
			}
		}
	},
	colors: [],
	...
	render: function() {
		...
		var poll = {answer_options: this.state.answer_options, votes: this.state.votes} ;
