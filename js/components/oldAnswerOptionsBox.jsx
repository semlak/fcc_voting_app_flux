...
var AnswerOptionsBox = React.createClass({
	//this is the original AnswerOptionsBox that builds its own newAnswerOptionForm rather than using the separate component
	getInitialState: function() {
	...
	handleAnswerOptionAdd: function(e) {
		...
		// console.log("in 'handleAnswerOptionAdd' of AnswerOptionsBox, props is", this.props)

		// If options_are_editable is false, then we don't allow adding a blank ('') answer_option (the last one is still blank).
		// Explanation:
		// 	For a new poll form, the user can add an answer option that is blank (''). However, if it is an existing poll form, we don't allow
		// 	this.props.options_are_editable being true actually indicates it is a new_poll_form.
		// var updated_answer_options = this.props.answer_options
		// var new_answer_option = this.props.new_answer_option;

		// this.props.handleAnswerOptionsListChange(updated_answer_options)
	...
	render: function() {
		// console.log("rendering AnswerOptionsBox, props are ", this.props)
	...
	// 					placeholder={(this.props.user == null ? 'Login to add a poll answer option' : 'Enter a new poll answer option here')}
		...
		var newAnswerOptionForm = (
			<Grid>
	        <FormGroup controlId="formNewAnswerOption" validationState={validationState}>
	        	<FormGroup controlId='blah' validationState={validationState}>
		          <FormControl
								type="text"
...
var AnswerOptionsBoxNew = React.createClass({
...
export {AnswerOptionsBox, AnswerOptionsList, AnswerOption, NewAnswerOptionForm, AnswerOptionsBoxNew}
